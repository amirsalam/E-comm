        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <form class="form-inline mt-2 mt-md-0">
                    ...
                    <button class="btn btn-primary my-2 my-sm-0 mr-3">
Search</button>
        ...
        <div class="container marketing">
            ...
            <div class="row featurette">
                <div class="col-md-7 order-md-<?=$first_order; ?>">
                    ...
                    <a class="btn btn-lg btn-danger" href="Admin/delete.php" role="button">Delete</a>
                    <a class="btn btn-lg btn-success" href="Admin/edit.php" role="button">Update</a>
                    <a class="btn btn-lg btn-primary" href="Admin/add.php" role="button">Add</a>
                </div>
